                            ...
                            <div className="flex-1 overflow-y-auto">
                                {chats.map(chat => (
                                    <button
                                        ...
                                        className={`w-full text-left p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-start gap-3 border-b border-gray-100 dark:border-gray-800 ${selectedChat === chat.id ? "bg-blue-50 dark:bg-blue-900/10" : ""
                                            }`}
                                    >
                                        <div className="h-10 w-10 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center flex-shrink-0">
                                            <User className="text-gray-500 dark:text-gray-400 w-6 h-6" />
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400 truncate">{chat.lastMsg}</p>
                                        </div>
                                    </button>
                                ))}
                            </div>
